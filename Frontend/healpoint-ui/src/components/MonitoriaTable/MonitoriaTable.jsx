...
export default function MonitoriaTable() {
  ...
  const cargarRegistros = async () => {
    try {
      setLoading(true);
      setError("");
      const response = await axios.get("http://localhost:8080/monitoria");
  ...
  const getNombreUsuario = (usuarioResponsable) => {
    ...
    return `${usuarioResponsable.nombre} ${usuarioResponsable.apellido}`;
  };

  const getRolUsuario = (usuarioResponsable) => {
    if (!usuarioResponsable) return "Sistema";
    return usuarioResponsable.rol || "Usuario";
  };
      ...
      <div className="monitoria-card">
        ...
        <div className="stats-bar">
          ...
          <div className="stat-item">
            ...
            <div className="stat-info">
              <span className="stat-value">
                {registrosFiltrados.filter(r => r.accion === "INSERT").length}
              </span>
          ...
          <div className="stat-item">
            ...
            <div className="stat-info">
              <span className="stat-value">
                {registrosFiltrados.filter(r => r.accion === "UPDATE").length}
              </span>
          ...
          <div className="stat-item">
            ...
            <div className="stat-info">
              <span className="stat-value">
                {registrosFiltrados.filter(r => r.accion === "DELETE").length}
              </span>
                  ...
                  return (
                    <tr key={registro.idMonitoria} className="table-row">
                      ...
                      <td className="td-tabla">
                        <span className="tabla-name">{registro.tablaAfectada}</span>
                      </td>
